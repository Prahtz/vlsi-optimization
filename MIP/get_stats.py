...
times = pd.DataFrame(data=times)[['out_complete_cbc', 'out_complete_cpx', 'out_complete_gui']]
times = times.rename(columns={'out_complete_cbc': 'COIN-BC/CBC', 'out_complete_cpx':'CPLEX', 'out_complete_gui':'GUROBI'})
